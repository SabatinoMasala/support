...
abstract class ServiceProvider extends IlluminateServiceProvider {
	...
	private function registerConfig()
	{
		...
		$this->app[$this->packageName.'.config'] = $this->app->singleton($this->packageName . '-config', function($app)
		{
			// Waiting for https://github.com/laravel/framework/pull/7440
	...
	{
		$this->app[$this->packageName.'.fileSystem'] = $this->app->singleton($this->packageName . '-filesystem', function($app)
		{
